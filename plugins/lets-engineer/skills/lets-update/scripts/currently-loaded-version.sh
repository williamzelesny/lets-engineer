...
# marketplace cache layout `~/.claude/plugins/cache/<marketplace>/lets-engineer/<version>/skills/lets-update`,
...
# Match `.../plugins/cache/*/lets-engineer/<version>/skills/lets-update[/]?`
