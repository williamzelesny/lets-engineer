...
Files live under `<scratch-dir>/web-research-cache.json`, where `<scratch-dir>` is `/tmp/lets-engineer/lets-ideate/<run-id>`, resolved once in SKILL.md Phase 1.
...
```bash
SCRATCH_ROOT="/tmp/lets-engineer/lets-ideate"
