...
- `output_schema` — the structure the agent's response should follow. Default schema:
  ...
  - Related context
  ```
  When the caller (e.g., `lets-compound`) supplies a schema in the skill argument, pass it through verbatim.
