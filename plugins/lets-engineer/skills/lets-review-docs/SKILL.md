...
```
Reviewing with:
- lets-coherence-reviewer (always-on)
- lets-feasibility-reviewer (always-on)
- lets-scope-guardian-reviewer -- plan has 12 requirements across 3 priority levels
- lets-security-lens-reviewer -- plan adds API endpoints with auth flow
```

### Build Agent List

Always include:
- `lets-coherence-reviewer`
- `lets-feasibility-reviewer`

Add activated conditional personas:
- `lets-product-lens-reviewer`
- `lets-design-lens-reviewer`
- `lets-security-lens-reviewer`
- `lets-scope-guardian-reviewer`
- `lets-adversarial-document-reviewer`
