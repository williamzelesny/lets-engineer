---
name: lets-git-history-analyzer
...
Note that files in `docs/plans/` and `docs/solutions/` are lets-engineer pipeline artifacts created by `/lets-plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
