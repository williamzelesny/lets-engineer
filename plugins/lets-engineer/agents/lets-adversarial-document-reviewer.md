---
name: lets-adversarial-document-reviewer
...
- **Internal contradictions** or terminology drift -- lets-coherence-reviewer owns these
- **Technical feasibility** or architecture conflicts -- lets-feasibility-reviewer owns these
- **Scope-goal alignment** or priority dependency issues -- lets-scope-guardian-reviewer owns these
- **UI/UX quality** or user flow completeness -- lets-design-lens-reviewer owns these
- **Security implications** at plan level -- lets-security-lens-reviewer owns these
- **Product framing** or business justification quality -- lets-product-lens-reviewer owns these
