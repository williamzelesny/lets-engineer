---
name: lets-schema-drift-detector
...
- Run `lets-schema-drift-detector` first to ensure clean schema
- Then run `lets-data-migration-expert` for migration logic review
- Then run `lets-data-integrity-guardian` for integrity checks
